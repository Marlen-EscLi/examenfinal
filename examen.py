...
entrada1 = StringVar()
etiqueta1 = tkinter.Label(ventana, text = "Nombre", font = ("Century Gothic", 18)).place(x = 70, y = 40)
textetiqueta1 = Entry(ventana, textvariable = entrada1, width = 25).place(x = 180, y = 43)

entrada2 = StringVar()
etiqueta2 = tkinter.Label(ventana, text = "Apellido", font = ("Century Gothic", 18)).place(x = 70, y = 67)
textetiqueta2 = Entry(ventana, textvariable = entrada2, width = 25).place(x = 180, y = 73)


entrada3 = StringVar()
etiqueta3 = tkinter.Label(ventana, text = "Día", font = ("Century Gothic", 18)).place(x = 70, y = 95)
textetiqueta3 = Entry(ventana, textvariable = entrada3, width = 25).place(x = 180, y = 100)

entrada4 = StringVar()
etiqueta4 = tkinter.Label(ventana, text = "Mes", font = ("Century Gothic", 18)).place(x = 70, y = 125)
textetiqueta4 = Entry(ventana, textvariable = entrada4, width = 25).place(x = 180, y = 130)
